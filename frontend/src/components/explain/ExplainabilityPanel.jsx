  ...
  return (
    <div className="card p-6 bg-card border border-border rounded-lg animate-in fade-in">
      ...
      <div className="rounded-xl p-4 mb-6 bg-cyan-500/5 border border-cyan-500/15">
        <h4 className="text-xs font-semibold tracking-wider uppercase mb-2 text-cyan-400">
          Methodology
        </h4>
          ...
          >
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="rounded-lg p-3 mb-2 text-xs overflow-x-auto bg-background border border-border font-mono text-cyan-600">
                  {step.formula}
                </div>
                ...
                <div className="mt-2 text-xs rounded-lg p-2 bg-surface text-muted-foreground">
                  {step.interpretation}
                </div>
              </div>
            </div>
          ...
          {Object.entries(data.feature_contributions)
            ...
            .map(([feat, val]) => (
              <div key={feat} className="flex items-center gap-3">
                <span className="w-36 text-[0.6875rem] truncate shrink-0 text-muted-foreground">
                  {feat.replace(/_/g, ' ')}
                </span>
