          ...
          {error && (
            <div className="rounded-xl p-4 mb-6 flex items-start gap-3 animate-in fade-in bg-red-500/5 border border-red-500/25 text-red-400" role="alert">
              ...
              <div className="flex-1">
                ...
                <button onClick={() => setError(null)} className="text-xs mt-1 underline hover:opacity-80 text-red-400">
                  Dismiss
                </button>
              </div>
            </div>
              ...
              <div className="lg:col-span-4 space-y-6">
                ...
                <div className="bg-card border border-border rounded-lg p-5">
                  <div className="flex items-center justify-between mb-4">
                    <h3 className="text-xs font-semibold tracking-wider uppercase flex items-center gap-2 font-mono text-muted-foreground">
                  ...
                  <div className="space-y-3">
                    {demos.length === 0 && !demosLoading && (
                      <div className="py-6 text-center">
                        ...
                        <p className="text-xs text-muted-foreground">Click "Load Demos" to analyze Equifax, Capital One, and Marriott breaches.</p>
                      </div>
                    )}
                    {demos.length === 0 && demosLoading && (
              ...
              <div className="lg:col-span-8 space-y-6" aria-live="polite">
                ...
                {!score && !loading && !error && (
                  <div className="bg-card border border-border rounded-lg py-16 text-center">
                    <svg className="w-14 h-14 text-muted-foreground mx-auto mb-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <p className="text-xs text-muted-foreground">Enter a company name in the form or load a demo to see the risk analysis.</p>
                  </div>
                )}

                {score && (
                  <>
                    <div className="bg-card border border-border rounded-lg corner-accent p-6 animate-in fade-in">
                      <div className="flex items-center justify-between mb-4">
                        <div>
                          <h3 className="text-xl font-bold font-mono text-foreground">{score.company}</h3>
                          <span className="text-xs tracking-wider uppercase text-muted-foreground">{score.ticker}</span>
                        </div>
                    ...
                    <div className="bg-card border border-border rounded-lg p-6 animate-in fade-in">
                      <h4 className="text-xs font-semibold tracking-wider uppercase mb-4 font-mono text-muted-foreground">
                      ...
                      <div className="mt-4 pt-3 flex items-center justify-between text-xs border-t border-border">
                        ...
                        <span className="font-semibold text-cyan-400">{(score.confidence * 100).toFixed(1)}%</span>
                      </div>
                    </div>
                    ...
                    {score.features && (
                      <div className="bg-card border border-border rounded-lg p-6 animate-in fade-in">
                        ...
                        <h4 className="text-xs font-semibold tracking-wider uppercase mb-3 font-mono text-muted-foreground">
            ...
            <div className="max-w-4xl mx-auto">
              {explainLoading && (
                <div className="bg-card border border-border rounded-lg p-12 text-center">
                  ...
                  <p className="text-sm text-muted-foreground">Generating explainability report...</p>
                </div>
              )}
          ...
          {activeTab === 'settings' && (
            <div className="max-w-4xl mx-auto">
              ...
              <div className="bg-card border border-border rounded-lg p-5 mt-6">
                ...
                <div className="rounded-lg p-4 text-xs overflow-x-auto bg-background border border-border font-mono text-muted-foreground">
                  <pre>{JSON.stringify(analysisConfig, null, 2)}</pre>
                </div>
                <p className="text-[0.65rem] mt-3 text-muted-foreground">
